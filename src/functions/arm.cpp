...
#define ARRAY_LENGTH(a) (sizeof(a) / sizeof(a[0]))
	...
	void servo_minus(const CommandBuffer *b)
	{
		...
		{
			LOG_ARM_NL("Abort servo minus - buffer was null");
		}
	}
	...
	void servo_plus(const CommandBuffer *b)
	{
		...
		{
			LOG_ARM_NL("Abort servo plus - buffer was null");
		}
	}
	...
	void servo_stop(const CommandBuffer *b)
	{
		...
		{
			LOG_ARM_NL("Abort servo stop - buffer was null");
		}
	}
	...
	void servo_angle(const CommandBuffer *b)
	{
		...
		{
			LOG_ARM_NL("Abort servo angle - buffer was null");
		}
	}
